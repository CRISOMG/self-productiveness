...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pomodoro_state') THEN
        CREATE TYPE public."pomodoro_state" AS ENUM ('current', 'paused', 'finished');
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pomodoro_type') THEN
        CREATE TYPE public."pomodoro_type" AS ENUM ('focus', 'break', 'long-break');
